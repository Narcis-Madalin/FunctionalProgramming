...
public class CrazyLambdas {
    ...
    public static BiFunction<String, Integer, String> stringMultiplier() {
        //throw new UnsupportedOperationException("It's your job to implement this method"); //
        return (str, nr) -> {String finalStr = str; for (int i = 0; i < nr; i++){ finalStr += str;} return finalStr;};
    }
    ...
    public static Function<BigDecimal, String> toDollarStringFunction() {
        //throw new UnsupportedOperationException("It's your job to implement this method");
        return (bigNr) -> {return "$" + bigNr.toString();};
    }
    ...
    public static Predicate<String> lengthInRangePredicate(int min, int max) {
        //throw new UnsupportedOperationException("It's your job to implement this method");
        return (str) -> {return (str.length() >= min && str.length() < max);};
    }
    ...
    public static IntSupplier randomIntSupplier() {
        //throw new UnsupportedOperationException("It's your job to implement this method");
        return () -> {Random rn = new Random(); return rn.nextInt();};
    }
    ...
    public static IntUnaryOperator boundedRandomIntSupplier() {
        //throw new UnsupportedOperationException("It's your job to implement this method");
        return (n) -> {Random rn = new Random(); return rn.nextInt();};
    }
    ...
    public static LongBinaryOperator longSumOperation() {
        //throw new UnsupportedOperationException("It's your job to implement this method");
        return (firstNr, secondNr) -> firstNr + secondNr;
        //return Long::sum;
    }
    ...
    public static ToIntFunction<String> stringToIntConverter() {
        //throw new UnsupportedOperationException("It's your job to implement this method");
        return str -> {return Integer.parseInt(str);};
    ...
    public static Supplier<IntUnaryOperator> nMultiplyFunctionSupplier(int n) {
        ...
        //return () -> { (x) -> {return x * n;}; }; - nu merge si nu stiu de ce

        IntUnaryOperator uo = (x) -> {return x * n;};
        return () -> { return uo; };
    ...
    public static UnaryOperator<Function<String, String>> composeWithTrimFunction() {
        //throw new UnsupportedOperationException("It's your job to implement this method");
        Function fct = (firstStr) -> {return firstStr;};
        return (str) -> {return fct;};
    }
    ...
    public static Supplier<Thread> runningThreadSupplier(Runnable runnable) {
        //throw new UnsupportedOperationException("It's your job to implement this method");
        return () -> {Thread thread = new Thread(runnable); return thread;};
    }
    ...
    public static Consumer<Runnable> newThreadRunnableConsumer() {
        //throw new UnsupportedOperationException("It's your job to implement this method");
        return (run) -> {Thread thread = new Thread(run);};
    }
    ...
    public static Function<Runnable, Supplier<Thread>> runnableToThreadSupplierFunction() {
        //throw new UnsupportedOperationException("It's your job to implement this method");
        return (run) -> { return  () -> {return new Thread(run); }; };
    }
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        //throw new UnsupportedOperationException("It's your job to implement this method");
//        IntUnaryOperator iuo = (nr) -> {return nr;};
//        IntPredicate ip = (val) -> {return val % 10 == 0;};
        return (intUnaryOperator, ip) -> {return  (value) -> { if(ip.test(value)) {return intUnaryOperator.applyAsInt(value);} return value; };};
    }
